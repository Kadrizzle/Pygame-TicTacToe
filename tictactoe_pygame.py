...
open_spots = [True, True, True, True, True, True, True, True, True]
...
while running:
    ...
    if get_mouse_click() == True:
        ...
        if first_slot.collidepoint(mouse_x, mouse_y) and open_spots[0] == True:
        ...
        if second_slot.collidepoint(mouse_x, mouse_y) and open_spots[1] == True:
        ...
        if third_slot.collidepoint(mouse_x, mouse_y) and open_spots[2] == True:
        ...
        if fourth_slot.collidepoint(mouse_x, mouse_y) and open_spots[3] == True:
        ...
        if fifth_slot.collidepoint(mouse_x, mouse_y) and open_spots[4] == True:
        ...
        if sixth_slot.collidepoint(mouse_x, mouse_y) and open_spots[5] == True:
        ...
        if seventh_slot.collidepoint(mouse_x, mouse_y) and open_spots[6] == True:
        ...
        if eigth_slot.collidepoint(mouse_x, mouse_y) and open_spots[7] == True:
        ...
        if ninth_slot.collidepoint(mouse_x, mouse_y) and open_spots[8] == True:
